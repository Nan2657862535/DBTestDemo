...
public class DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    public DatabaseHelper(Context context)
    {
        ...
        Log.d(AppConstants.LOG_TAG, "com.example.nan.dbtestdemo.DatabaseHelper Constructor");
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        Log.d(AppConstants.LOG_TAG, "com.example.nan.dbtestdemo.DatabaseHelper onCreate");

        // 构建创建表的SQL语句（可以从SQLite Expert工具的DDL粘贴过来加进StringBuffer中）
        StringBuffer sBuffer = new StringBuffer();

        sBuffer.append("CREATE TABLE [" + DAILY_LIST + "] (");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        Log.d(AppConstants.LOG_TAG, "com.example.nan.dbtestdemo.DatabaseHelper onUpgrade");

        db.execSQL("DROP TABLE IF EXISTS " + DAILY_LIST);
        onCreate(db);
    ...
    public void onOpen(SQLiteDatabase db)
    {
        ...
        Log.d(AppConstants.LOG_TAG, "com.example.nan.dbtestdemo.DatabaseHelper onOpen");
    }
